...
echo '  _____     _ ____  _           _   _ ___ '
echo ' |  ___|_ _| |  _ \| |_   _ ___| | | |_ _|'
echo ' | |_ / _` | | |_) | | | | / __| | | || | '
echo ' |  _| (_| | |  __/| | |_| \__ \ |_| || | '
echo ' |_|  \__,_|_|_|   |_|\__,_|___/\___/|___|'
echo

# FAL+ easy installer

pushd /tmp >/dev/null
curl -o fui.json -sS -H 'Accept: application/vnd.github.v3+json' 'https://api.github.com/repos/piclane/FalPlusUI/releases/latest'
